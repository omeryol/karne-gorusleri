...
const openings = [
  ...
  "[Öğrenci Adı] için bu dönem, sorumluluk almayı öğrenmesi açısından epey faydalı geçti.",
  ...
  "[Öğrenci Adı] bu dönem bazen zorlandı ama içinde çok güzel şeyler olduğunu biliyorum.",
  ...
  "[Öğrenci Adı] derslere girip çıksa da bu dönem istediğimiz gibi olmadı açıkçası.",
  ...
  "[Öğrenci Adı]'yla bu dönem en çok üzerinde durduğumuz konu, düzenli tekrar alışkanlığı kazanmaktı.",
  "[Öğrenci Adı] bu dönem sınıfta gösterdiği halinden çok daha fazlasını yapabilecek güçte aslında.",
  ...
  "[Öğrenci Adı] için bu dönem, düzenli çalışmayı öğrenmesi için aslında çok önemli bir fırsattı.",
  ...
  "[Öğrenci Adı]'yla bu dönem, kendi başına çalışmayı öğrenmesi gerektiğini açıkça gördük.",
  ...
  "[Öğrenci Adı]'nın bu dönemki çalışma temposu pek dengeli değildi, her gün aynı şekilde çalışmayı öğrenmeli.",
  "[Öğrenci Adı] için bu dönem, kendi başına hareket etmeyi öğrenmesi gereken bir zamandı aslında.",
...
const positiveOpenings = [
  ...
  "[Öğrenci Adı] bu dönem derslerdeki başarısıyla hepimizi gururlandırdı.",
  ...
  "[Öğrenci Adı]'nın bu dönemkı çalışma azmi gerçekten takdire değerdi doğrusu.",
  ...
  "[Öğrenci Adı]'nın bu dönemde yaptıkları, onun ne kadar özel bir öğrenci olduğunu bir kez daha gösterdi.",
  "[Öğrenci Adı] ile geçirdiğimiz bu dönem, onun hem derslerde hem de kişiliği olarak ne kadar olgunlaştığını görmek çok kıymetliydi.",
];
