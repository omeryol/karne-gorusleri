...
/*
    ...
    Buradaki her 'export const' tanımlamasının, 'index.html' dosyasındaki
    ilgili ID veya sınıf adına doğru bir şekilde karşılık geldiğini doğrulamak kritik öneme sahiptir.
    
    ÖNEMLİ: Bu dosyadaki kodlar, 'index.html' içinde `type="module"` ile yüklendiği için,
    ancak tüm HTML dökümanı tarayıcı tarafından okunduktan sonra çalışır. Bu nedenle,
    buradaki `document.getElementById` çağrılarının DOM yüklenmeden çalışıp 'null' dönme riski yoktur.
*/
